        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="http://linkedin.com/in/bernard-ofori-atta-Mentors Foundation Globalrs-foundation-ghana-a55b2233
"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 border border-gray-600 text-gray-300 rounded-md hover:text-white hover:bg-primary transition"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Mentors Foundation Globalrs Foundation Ghana. All rights
              reserved.
            </p>
