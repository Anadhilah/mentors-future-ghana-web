        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-muted-foreground">
              ...
              through mentorship, skills training, mental health education, and advocacy. His organization collaborates 
            ...
            <p className="text-muted-foreground mb-4">
              {isMoreStoryExpanded ? (
                <>
                  ...
                  mentorship leader, brand ambassador, and UN Peace Advocate honored with numerous awards and recognitions 
