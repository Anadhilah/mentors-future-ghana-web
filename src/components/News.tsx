...
const newsItems = [
  ...
  },
  {
    ...
    content: "Exciting partnership with MTN Foundation to provide extensive skill-based job training from August 2025 to December 2027. This program will offer practical skills training, mentorship, and job placement support to empower youth in our communities with valuable workforce skills.",
